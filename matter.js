...
function runMatter() {
  ...
  var attractiveBody = Bodies.rectangle(
    render.options.width / 2,
    render.options.height / 2,
    Math.max(dimensions.width / 25, dimensions.height / 25),
    Math.max(dimensions.width / 25, dimensions.height / 25),
    {
      render: {
        fillStyle: `#000`,
  ...
  for (var i = 0; i < 60; i += 1) {
    ...
    let w = Common.random(10, 80);
    let h = Common.random(10, 80);
    ...
    var rectangle = Bodies.rectangle(x, y, w * 1.5, h * 1.5, {
      mass: 6,
      friction: 0,
      frictionAir: 0,
      render: {
    ...
    var rectangle = Bodies.rectangle(x, y, w * 2, h * 2, {
      mass: 0.2,
      friction: 0.6,
      frictionAir: 0.8,
      render: {
